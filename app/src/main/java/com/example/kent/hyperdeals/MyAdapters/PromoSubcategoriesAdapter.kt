...
class PromoSubcategoriesAdapter (var context: Context, var selectedList : ArrayList<String>) : RecyclerView.Adapter<PromoSubcategoriesAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PromoSubcategoriesAdapter.ViewHolder, position: Int) {
